...
public class PatientByRequestDTOValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        } else if (patientService.findByEmail(patientDTO.getEmail()) > 0) {
        ...
        if (patientDTO.getPhone() == null) {
            ...
            errors.rejectValue("phone", "phone.format", "Số điện thoại đúng định dạng");
        } else if (patientService.findByPhone(patientDTO.getPhone()) > 0) {
